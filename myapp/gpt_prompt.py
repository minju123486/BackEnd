...
{tempt_problem} 문제는 이미 있으니까 비슷한 내용으로 내지마 
예제를 자료로 참고할 수 없으니 예제 관련된 문제는 내지마. ex(특정 클래스나 메소드 이름)
...
{tempt_problem} 문제는 이미 있으니까 비슷한 내용으로 내지마 절대 내면 안돼 그리고 내달라는 양식으로 정확하게 내줘.
OX문제로 내줘야해 꼭
문제를 출력할 때 내가 놓은 제약조건을 지키는 게 제일 중요해. 그리고 문제는 반드시 한글로 내줘
'''
