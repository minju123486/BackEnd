"""
Django settings for capde project.
...
SECRET_KEY = 'django-insecure-h=#_5#_ok_t484v%h#1uvh#_l=)fquml)1m+twm15%h#s_t5dc'
...
WSGI_APPLICATION = 'capde.wsgi.application'
